...
#' parameter \code{sv} to some positive value, e.g. \code{sv = .75}.
#'
...
#' key distinction is that \code{n_terms_small = "Foster"} uses a new method of
#' truncating the infinite sum. The \code{n_terms_small = "Foster"} method is
