...
#' @import Rcpp
#' @export
da_log_dfddm <- function(rt, response, a, v, t0, w = 0.5, sv = 0.0, sigma = 1.0, sl_thresh = 0.5, err_tol = 0.000001) {
    .Call(`_fddm_da_log_dfddm`, rt, response, a, v, t0, w, sv, sigma, sl_thresh, err_tol)
}
...
#' @import Rcpp
#' @export
dv_log_dfddm <- function(rt, response, a, v, t0, w = 0.5, sv = 0.0, sigma = 1.0, sl_thresh = 0.5, err_tol = 0.000001) {
    .Call(`_fddm_dv_log_dfddm`, rt, response, a, v, t0, w, sv, sigma, sl_thresh, err_tol)
}
...
#' @import Rcpp
#' @export
dsv_log_dfddm <- function(rt, response, a, v, t0, w = 0.5, sv = 0.0, sigma = 1.0, sl_thresh = 0.5, err_tol = 0.000001) {
    .Call(`_fddm_dsv_log_dfddm`, rt, response, a, v, t0, w, sv, sigma, sl_thresh, err_tol)
}
...
#' @import Rcpp
#' @export
dfddm <- function(rt, response, a, v, t0, w = 0.5, sv = 0.0, sigma = 1.0, log = 0L, n_terms_small = "SWSE", summation_small = "2017", scale = "both", max_terms_large = 1L, err_tol = 0.000001) {
