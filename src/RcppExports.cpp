...
// dfddm
NumericVector dfddm(const NumericVector& rt, const SEXP& response, const NumericVector& a, const NumericVector& v, const NumericVector& t0, const NumericVector& w, const NumericVector& sv, const NumericVector& sigma, const bool& log, const std::string& n_terms_small, const std::string& summation_small, const std::string& scale, const double& switch_thresh, NumericVector err_tol);
RcppExport SEXP _fddm_dfddm(SEXP rtSEXP, SEXP responseSEXP, SEXP aSEXP, SEXP vSEXP, SEXP t0SEXP, SEXP wSEXP, SEXP svSEXP, SEXP sigmaSEXP, SEXP logSEXP, SEXP n_terms_smallSEXP, SEXP summation_smallSEXP, SEXP scaleSEXP, SEXP switch_threshSEXP, SEXP err_tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericVector& >::type rt(rtSEXP);
    ...
    Rcpp::traits::input_parameter< const double& >::type switch_thresh(switch_threshSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type err_tol(err_tolSEXP);
    rcpp_result_gen = Rcpp::wrap(dfddm(rt, response, a, v, t0, w, sv, sigma, log, n_terms_small, summation_small, scale, switch_thresh, err_tol));
    return rcpp_result_gen;
END_RCPP
}
// ndfddm
NumericVector ndfddm(const NumericVector& rt, const SEXP& response, const NumericVector& a, const NumericVector& v, const NumericVector& t0, const NumericVector& w, const NumericVector& sv, const NumericVector& sigma, const bool& log, const std::string& n_terms_small, const std::string& summation_small, const std::string& scale, const double& sl_thresh, NumericVector err_tol);
RcppExport SEXP _fddm_ndfddm(SEXP rtSEXP, SEXP responseSEXP, SEXP aSEXP, SEXP vSEXP, SEXP t0SEXP, SEXP wSEXP, SEXP svSEXP, SEXP sigmaSEXP, SEXP logSEXP, SEXP n_terms_smallSEXP, SEXP summation_smallSEXP, SEXP scaleSEXP, SEXP sl_threshSEXP, SEXP err_tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericVector& >::type rt(rtSEXP);
    ...
    Rcpp::traits::input_parameter< const double& >::type sl_thresh(sl_threshSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type err_tol(err_tolSEXP);
    rcpp_result_gen = Rcpp::wrap(ndfddm(rt, response, a, v, t0, w, sv, sigma, log, n_terms_small, summation_small, scale, sl_thresh, err_tol));
    return rcpp_result_gen;
END_RCPP
}
// pfddm
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_fddm_ndfddm", (DL_FUNC) &_fddm_ndfddm, 14},
