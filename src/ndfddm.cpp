...
#include "ndfddm_helper_functions/func_defs.h"
#include "ndfddm_helper_functions/helper_funcs.h"
#include "ndfddm_helper_functions/density_funcs.h"
#include "ndfddm_helper_functions/sum_funcs.h"
#include "ndfddm_helper_functions/num_funcs.h"
...
//' @export
// [[Rcpp::export]]
NumericVector ndfddm(const NumericVector& rt,
                    const SEXP& response,
                    ...
                    NumericVector err_tol = 0.000001)
{
  ...
  ndetermine_method(n_terms_small, summation_small, scale,
  ...
  ncalculate_pdf(Nrt, Na, Nv, Nt0, Nw, Nsv, Nsig, Nerr,
                Nmax, rt, a, v, t0, w, sv, sigma,
                err_tol, out, sl_thresh,
                numf, sumf, denf, rt0);
