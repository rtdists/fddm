...
<li><a href="#ex1">Example Fitting</a>
...
This vignette contains examples of how to use `fddm`, in particular the `dfddm` function, in fitting the DDM to real-world data. We will load a dataset that is included in the `fddm` package and fit the Ratcliff DDM to the response time data contained within the dataset. After running the optimization, we provide a rudimentary analysis of the fitted parameter estimates.
