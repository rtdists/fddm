...
med_dec <- subset(med_dec, id == "21" & group == "novice")
...
# sorry, for now it's in the variable "fita" and maybe BmTime is already in sec
...
Some comment on what the plot looks like.
...
Some concluding comments on what all three of the plots look like
