...
```{r bm-run-internal, eval=FALSE, include=FALSE}
...
```{r fit-run-internal, eval=FALSE, include=FALSE}
save(fit, file = "inst/extdata/bm_fit.Rds", compress = "xz")
```
...
fit_prep <- function(fit) {
  ...
  fit$BmTime <- fit$BmTime/1e6 # convert to seconds
