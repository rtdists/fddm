...
Names <- c("fb_SWSE_17", "fb_Gon_17", "fb_Nav_17", "rtdists")
Color <- c("#e000b4", "#e68a00", "#006699", "#990000")
Shape <- c(21, 25)
Sizes <- c(0, 3, 3)
Stroke <- c(0, 1, 1)
