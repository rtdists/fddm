...
save(fit, file = "inst/extdata/fit.Rds", compress = "xz")
```
...
# Account for KE 5
fit <- subset(fit, Algorithm != "fs_Nav_17" | a_init > .75)
...
5) If the starting parameter value for $a \leq 0.75$ then the optimization that uses Navarro small-time density approximation yields inaccurate parameter estimates for all of the fitted parameters, yet `nlminb` claims to have converged.
