...
1 paragraph summary of the document - say that it's technical
check if compiles even if error (testthat checks fail)
compares the dens func across all
second part is fitting
  - include sv in fitting
...
```{r validity-run, eval=TRUE, collapse=TRUE}
library("fddm")
library("rtdists")
library("RWiener")
