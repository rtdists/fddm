...
med_dec <- subset(med_dec, id == 2 & group == "novice")
fit <- rt_fit(med_dec, id_idx = c(2,1), rt_idx = 8, response_idx = 7,
              truth_idx = 5, response_upper = "blast", err_tol = 1e-6)
# save(fit, file = "inst/extdata/valid_fit1.Rds", compress = "xz", compression_level = 9)
```
