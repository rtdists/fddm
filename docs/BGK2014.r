...
# eps: required precision
#
fs14_R = function(t, v, a, w, eps=sqrt(.Machine$double.eps))
{
    g = 1/a/a * exp(-v*a*w - v*v*t/2)
    return(g * fsw14_R(t/a/a, w, eps/g))
}

#
# Examples
#
# test1 <- Fs(t=1:1000, v=-0.1, a=100, w=0.4)# for the distribution within 1-1000 ms
# Ks(t=1:1000, v=-0.1, a=100, w=0.4, eps=sqrt(.Machine$double.eps))
# test2 <- fs(t=1:1000, v=-0.1, a=100, w=0.4)# for the density
