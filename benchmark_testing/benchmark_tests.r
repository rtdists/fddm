...
RT_12_30 = c(seq(12.5, 20, by = 2.5),
             seq(25, 30, by = 5))
A = seq(0.5, 2.5, by = 0.5)#c(0.25, seq(0.5, 5, by = 0.5))
V = seq(-2, 2, by = 1)#seq(-6, 6, by = 0.5)
t0 = 1e-4 # must be nonzero for RWiener
W = seq(0.2, 0.8, by = 0.3)#seq(0.2, 0.8, by = 0.1)
...
sim_vec <- rt_benchmark(RT = c(RT_0_3, RT_4_10), resp = 0, V = V, A = A, W = W, t0 = t0,
                        ...
                        times = 1000, unit = "us")
saveRDS(sim_vec, file = "benchmark_testing/Results/vec_0-10_1000w_TEST2.Rds")
