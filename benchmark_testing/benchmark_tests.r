...
# Run benchmark tests
sim <- rt_benchmark(RT = RT_0_3, resp = 0, V = V, A = A, W = W, t0 = t0,
                    err_tol = err_tol, rt_as_vec = FALSE,
                    times = 10000, unit = "us")
saveRDS(sim, file = "benchmark_testing/Results/sim_0-3_10000.Rds")
...
sim_vec <- readRDS("benchmark_testing/Results/vec_100000.Rds")
