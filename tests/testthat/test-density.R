...
### Can either read the result dataframe in the following lines or
res <- readRDS(system.file("extdata", "test-density-res.Rds", package = "fddm", mustWork = TRUE))
SV_THRESH <- 0.05
...
### can rerun everything in the following commented lines (takes a long time)
# library("rtdists")
# library("RWiener")
...
#   }
# }
# saveRDS(res, file = system.file("extdata", "test-density-res.Rds", package = "fddm", mustWork = TRUE))
...
#    negative) and the logarithm function returns a value of -Inf.
