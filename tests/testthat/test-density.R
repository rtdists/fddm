...
test_that("Input checking", {
  ...
  # rt
  expect_equal(
    dfddm(rt = c(0, -1, Inf, -Inf), response = 1, a = 1, v = -1, t0 = 0, w = 0.5,
  ...
  expect_warning(expect_equal(
    dfddm(rt = 1, response = c(3, -1, Inf, -Inf), a = 1, v = -1, t0 = 0, w = 0.5,
          sv = 0, sigma = 1, log = 0, err_tol = 1e-6),
    c(0, 0, 0, 0)
  ))
  ...
  expect_warning(expect_equal(
    dfddm(rt = 1, response = c("l", "u", Inf, -Inf, NaN, NA), a = 1, v = -1, t0 = 0, w = 0.5,
          sv = 0, sigma = 1, log = 0, err_tol = 1e-6)[1:4],
    c(dfddm(rt = 1, response = c("l", "u"), a = 1, v = -1, t0 = 0, w = 0.5,
          sv = 0, sigma = 1, log = 0, err_tol = 1e-6), 0, 0)
  ))
  expect_warning(expect_true(all(c(
    is.nan(dfddm(rt = 1, response = c("l", "u", Inf, -Inf, NaN, NA), a = 1, v = -1, t0 = 0, w = 0.5,
                 sv = 0, sigma = 1, log = 0, err_tol = 1e-6)[5]),
    is.na(dfddm(rt = 1, response = c("l", "u", Inf, -Inf, NaN, NA), a = 1, v = -1, t0 = 0, w = 0.5,
                sv = 0, sigma = 1, log = 0, err_tol = 1e-6)[6])
  ))))

  # a
  expect_true(all(c(
    is.nan(dfddm(rt = 1, response = 1, a = c(-0.4, 0, NaN, -Inf), v = -1, t0 = 0,
                 w = 0.5, sv = 0, sigma = 1, log = 0, err_tol = 1e-6)),
    is.na(dfddm(rt = 1, response = 1, a = NA, v = -10, t0 = 0,
                w = 0.5, sv = 0, sigma = 1, log = 0, err_tol = 1e-6))
  )))
  expect_equal(
    dfddm(rt = 1, response = 1, a = Inf, v = -10, t0 = 0, scale = "l", n_terms_small = "n",
               w = 0.5, sv = 0, sigma = 1, log = 0, err_tol = 1e-6),
    0
  )
  ...
  expect_true(all(c(
    is.nan(dfddm(rt = 1, response = 1, a = 1, v = -1, t0 = 0,
                 w = c(-0.5, 1.5, 0, 1, NaN, Inf, -Inf), sv = 0, sigma = 1, log = 0,
                 err_tol = 1e-6)),
  ...
  expect_true(all(c(
    is.nan(dfddm(rt = 1, response = 1, a = 1, v = -1, t0 = 0, w = 0.5,
                 sv = 0, sigma = c(-1, 0, NaN, Inf, -Inf), log = 0, err_tol = 1e-6)),
    is.na(dfddm(rt = 1, response = 1, a = 1, v = -1, t0 = 0, w = 0.5,
  ...
  expect_error(
      dfddm(rt = 1, response = 1, a = 1, v = -1, t0 = 0, w = 0.5,
            sv = 0, sigma = 1, log = 0, err_tol = c(-1e-6, 0, NA, NaN, Inf, -Inf))
  )
})
