...
`fddm` provides function `dfddm()` which evaluates the density function (or probability density function, PDF) for the Ratcliff diffusion decision model (DDM) using different methods for approximating the full PDF, which contains an infinite sum. Our implementation of the DDM has the following parameters: *a &#1013; (0, <sub><font size="+2">&#8734;</font></sub>)* (threshold separation), *v &#1013; (-<sub><font size="+2">&#8734;</font></sub>, <sub><font size="+2">&#8734;</font></sub>)* (drift rate), *t<sub>0</sub> &#1013; [0, <sub><font size="+2">&#8734;</font></sub>)* (non-decision time/response time constant), *w &#1013; (0, 1)* (relative starting point), and *sv &#1013; (0, <sub><font size="+2">&#8734;</font></sub>)* (inter-trial-variability of drift).
