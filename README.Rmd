...
We then pass the data and log-likelihood and the additional argument needed to an optimisation function. Here, we use `nlminb`. Note that the first argument are the starting values. We also need to define upper and lower bounds of the parameters, which are in order, vu, vl, a, t0, w, and sv. Fitting this is basically instanteneous.
