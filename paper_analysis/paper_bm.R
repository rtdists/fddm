...
save(bm_vec, compress = "xz", compression_level = 9,
     file = "paper_analysis/benchmark_data/bm_vec_0-2.Rds")
...
save(bm_ind, compress = "xz", compression_level = 9,
     file = "paper_analysis/benchmark_data/bm_ind_0-2.Rds")
...
ggsave("bm_vec_violin.png", width = 16, height = 9)
...
ggsave("bm_ind_rtaa.png", width = 16, height = 9)
...
ggplot(mbm_meq, aes(x = W, y = time,
  ...
  theme(panel.grid.minor = element_blank(),
        ...
        legend.position = "none") +
  facet_wrap(~ factor(FuncName, levels = Names_meq), scales = "free_y")
ggsave("bm_ind_w.png", width = 16, height = 9)
...
ggplot(mbm_meq, aes(x = V, y = time,
  ...
  theme(panel.grid.minor = element_blank(),
        ...
        legend.position = "none") +
  facet_wrap(~ factor(FuncName, levels = Names_meq), scales = "free_y")
ggsave("bm_ind_v.png", width = 16, height = 9)
...
ggplot(mbm_meq, aes(x = SV, y = time,
  ...
  theme(panel.grid.minor = element_blank(),
        ...
        legend.position = "none") +
  facet_wrap(~ factor(FuncName, levels = Names_meq), scales = "free_y")
ggsave("bm_ind_sv.png", width = 16, height = 9)
...
### load pre-fit data to see the parameter ranges
load(system.file("extdata", "valid_fit.Rds", package = "fddm", mustWork = TRUE))
head(fit)
plot(density(fit[["sv_fit"]]))

data(med_dec, package = "fddm")
plot(density(med_dec[["rt"]]))
