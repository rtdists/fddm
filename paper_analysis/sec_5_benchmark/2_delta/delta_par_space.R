...
# This file produces the results (and plots) that pertain to the implementations
# that combine the SWSE small-time method with the Navarro et al. large-time
# method on a predefined parameter space, as shown in
...
ggsave(paste0(img_dir, "delta_bm_vec_0-30.png"),
       plot = fig_4, width = 16, height = 9)
