...
# This file produces the results (and plots) that pertain to all of the
# implementations discussed in the fddm paper on a predefined parameter space,
# as shown in Section 5.3.1 of the fddm paper:
...
# Figure 6
fig_6 <- ggplot(mbm_vec, aes(x = factor(FuncName, levels = Names_vec), y = time,
...
ggsave(paste0(img_dir, "bm_vec_0-2.png"),
       plot = fig_6, width = 16, height = 9)
...
# Figure 8
fig_8 <- ggplot(mbm_meq, aes(x = RTAA, y = time,
...
ggsave(paste0(img_dir, "meq_rtaa_0-30.png"),
       plot = fig_8, width = 16, height = 9)
